...
;(function (a, b) {
    ...
    function a(b, c) {
        this.isScrollBody = (!b || b == "body");
        this.scrollDom = this.isScrollBody ? document.body : document.getElementById(b);
        this.options = c || {};
        ...
        a.extend(c, {
            ...
            onMoving: function (e, g, d) {
                if (e.downProgressDom) {
                    var f = 360 * g;
                    e.downProgressDom.style.webkitTransform = "rotate(" + f + "deg)";
            ...
            showLoading: function (d) {
                ...
                if (d.downProgressDom) {
                    d.downProgressDom.classList.add("mescroll-rotate")
                }
            },
            callback: function (d) {
                d.resetUpScroll()
    ...
    a.prototype.initDownScroll = function () {
        ...
        b.downparent = b.optDown.warpId ? document.getElementById(b.optDown.warpId) : b.scrollDom;
        if (b.optDown.warpId) {
            b.downparent.appendChild(b.downwarp)
        } else {
            b.downparent.insertBefore(b.downwarp, b.scrollDom.firstChild)
        }
        b.touchstartEvent = function (c) {
            if (b.isScrollTo) {
                c.preventDefault()
            }
            b.startTop = b.getScrollTop();
            b.endTouchmove = false;
            b.maxTouchmoveY = b.getBodyHeight() - b.optDown.bottomOffset;
            if (b.optDown.mustToTop) {
                b.startY = c.touches ? c.touches[0].pageY : c.clientY
            }
        };
        b.scrollDom.addEventListener("touchstart", b.touchstartEvent);
        b.scrollDom.addEventListener("mousedown", b.touchstartEvent);
        b.touchmoveEvent = function (j) {
            ...
            if (b.startTop != null && f <= 0 && !b.isDownScrolling && (!b.isUpScrolling || (b.isUpScrolling && b.optUp.isBoth)) && !b.optDown.isLock && !b.endTouchmove) {
                if (b.optDown.mustToTop && b.startTop > 0) {
                    return
                }
                var d = j.touches ? j.touches[0].pageX : j.clientX;
                var c = j.touches ? j.touches[0].pageY : j.clientY;
                if (!b.preX) {
                    b.preX = d
                }
                if (!b.preY) {
                ...
                var m = Math.abs(b.preX - d);
                var l = Math.abs(b.preY - c);
                var k = Math.sqrt(m * m + l * l);
                var n = c - b.preY;
                b.preX = d;
                b.preY = c;
                if (k != 0) {
                    var h = Math.asin(l / k) / Math.PI * 180;
                    if (h < b.optDown.minAngle) {
                        return
                    }
                }
                if (!b.startY && !b.optDown.mustToTop) {
                    b.startY = c
                }
                var g = c - b.startY - f;
                if (g > 0) {
                    j.preventDefault();
                    if (b.maxTouchmoveY > 0 && c >= b.maxTouchmoveY) {
                        b.endTouchmove = true;
                        b.touchendEvent();
                        return
                    }
                    ...
                    if (b.downHight < b.optDown.offset) {
                        ...
                        if (n > 0) {
                            b.downHight += n * b.optDown.outOffsetRate
                        } else {
                            b.downHight += n
                        }
                    }
                    b.downwarp.style.height = b.downHight + "px";
                    var i = b.downHight / b.optDown.offset;
                    b.optDown.onMoving(b, i, b.downHight)
                }
            }
        };
    ...
    a.prototype.initUpScroll = function () {
        ...
        b.upparent = b.optUp.warpId ? document.getElementById(b.optUp.warpId) : b.scrollDom;
        b.upparent.appendChild(b.upwarp);
        b.preScrollY = 0;
    ...
    a.prototype.loadFull = function () {
        var b = this;
        if (b.optUp.loadFull.use && !b.optUp.isLock && b.getScrollHeight() <= b.getClientHeight()) {
            setTimeout(function () {
    ...
    a.prototype.scrollTo = function (j, l) {
        ...
        var f = l / g;
        var h = this;
        var b = h.getScrollHeight() - h.getClientHeight();
        if (j < 0) {
            j = 0
        }
        if (j > b) {
    ...
    a.prototype.destroy = function () {
        ...
        if (b.optDown.use) {
            ...
            b.downparent && b.downparent.removeChild(b.downwarp)
        }
        if (b.optUp.use) {
            if (b.isScrollBody) {
            ...
            b.upparent && b.upparent.removeChild(b.upwarp)
        }
    };
    return a
});